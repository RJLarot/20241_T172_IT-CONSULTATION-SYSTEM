...
function AuthResetPasswordBasicc() {
  return (
<div>
  <meta charSet="utf-8" />
      ...
      <div className="authentication-inner py-4">
        ...
        <div className="card">
          <div className="card-body">
            ...
            <form id="formAuthentication" className="mb-3" action="auth-login-basic.html" method="POST">
...
export default AuthResetPasswordBasicc