    ...
    <div className="authentication-inner row m-0">
      ...
      <div className="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
        <div className="w-100 d-flex justify-content-center">
          <img src="assets/img/illustrations/girl-verify-password-light.png" className="img-fluid" alt="Login image" width={600} data-app-dark-img="illustrations/girl-verify-password-dark.png" data-app-light-img="illustrations/girl-verify-password-light.png" />
        </div>
      </div>
      {/* /Left Text */}
...
export default AuthTwoStepsCover