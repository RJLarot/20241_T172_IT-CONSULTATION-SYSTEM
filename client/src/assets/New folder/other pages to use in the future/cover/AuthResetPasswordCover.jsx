    ...
    <div className="authentication-inner row m-0">
      ...
      <div className="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
        <div className="w-100 d-flex justify-content-center">
          <img src="assets/img/illustrations/boy-with-laptop-light.png" className="img-fluid" alt="Login image" width={600} data-app-dark-img="illustrations/boy-with-laptop-dark.png" data-app-light-img="illustrations/boy-with-laptop-light.png" />
        </div>
      </div>
      {/* /Left Text */}
      {/* Reset Password */}
      <div className="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-4 p-sm-5">
        <div className="w-px-400 mx-auto">
          ...
          <form id="formAuthentication" className="mb-3" action="auth-login-cover.html" method="POST">
            ...
            <div className="mb-3 form-password-toggle">
              ...
              <div className="input-group input-group-merge">
                <input type="password" id="confirm-password" className="form-control" name="confirm-password" placeholder="············" aria-describedby="password" />
                <span className="input-group-text cursor-pointer"><i className="bx bx-hide" /></span>
              </div>
            </div>
            <button className="btn btn-primary d-grid w-100 mb-3">Set new password</button>
...
export default AuthResetPasswordCover