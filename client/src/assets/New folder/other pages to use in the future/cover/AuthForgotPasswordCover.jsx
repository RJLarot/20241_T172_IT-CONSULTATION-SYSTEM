    ...
    <div className="authentication-inner row m-0">
      ...
      <div className="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
        <div className="w-100 d-flex justify-content-center">
          <img src="assets/img/illustrations/girl-unlock-password-light.png" className="img-fluid" alt="Login image" width={600} data-app-dark-img="illustrations/girl-unlock-password-dark.png" data-app-light-img="illustrations/girl-unlock-password-light.png" />
        </div>
      </div>
      {/* /Left Text */}
      {/* Forgot Password */}
        ...
        <div className="w-px-400 mx-auto">
          ...
          <div className="app-brand mb-5">
            <a href="index.html" className="app-brand-link gap-2">
              ...
              <span className="app-brand-text demo demo text-body fw-bolder">Sneat</span>
            </a>
          </div>
          {/* /Logo */}
          <h4 className="mb-2">Forgot Password? 🔒</h4>
          <p className="mb-4">Enter your email and we'll send you instructions to reset your password</p>
          <form id="formAuthentication" className="mb-3" action="auth-reset-password-cover.html" method="POST">
            <div className="mb-3">
...
export default AuthForgotPasswordCover